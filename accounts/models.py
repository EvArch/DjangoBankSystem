...
class BankCard(models.Model):
    ...
    cc_number = models.CharField(max_length=512)
    cc_expiry = CardExpiryField('expiration date')
    cc_code = models.CharField(max_length=512)
    Security_PIN = models.CharField(max_length=512)
    def __str__(self):
        return self.cc_number[:4]+"********"+self.cc_number[-4:]
